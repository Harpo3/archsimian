...
void selectTrack(int *_sratingNextTrack){
    ...
    //int s_ratingNextTrack(*_sratingNextTrack);
    ...
    {  // Declare variables applicable to all rows
        ...
        if (notInPlaylist == 0) {
            ...
            continue;}
        else if (std::stoi(ratingCode) != *_sratingNextTrack) {
        ...
        while (std::getline(ratedSongsTable2, str3))
        {  // Declare variables applicable to all rows
